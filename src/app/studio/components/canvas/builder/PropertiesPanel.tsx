  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3">
        <div className="mb-3 rounded-lg border px-2.5 py-1.5 text-[10px] font-bold" style={{ borderColor: "var(--studio-border-strong)", color: "var(--text-muted)" }}>
          {node.type} · <span style={{ color: "var(--text-secondary)" }}>{node.id.slice(0, 12)}</span>
        </div>
        ...
        <div className="space-y-3">
          ...
          {/* Layout section */}
          <div className="border-t pt-2" style={{ borderColor: "var(--studio-border)" }}>
            <div className="mb-2 text-[10px] font-black uppercase tracking-[0.1em]" style={{ color: "var(--text-muted)" }}>
              Layout
            </div>
