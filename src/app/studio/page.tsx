...
function StudioHub() {
  ...
  if (!isLoaded) {
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#080a13] p-6">
  ...
  if (!isSignedIn) {
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#080a13] p-6">
        <div className="relative max-w-sm w-full rounded-2xl border border-white/10 bg-[#111522] p-8 text-center">
...
export default function StudioPage() {
  ...
  return (
    <Suspense
      fallback={
        <div
          className="flex min-h-screen items-center justify-center bg-[#080a13] p-6"
          style={{ color: T.textMuted }}
        >
