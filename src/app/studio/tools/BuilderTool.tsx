    ...
    <div className="mx-auto flex h-full w-full max-w-7xl flex-col gap-3 overflow-auto">
      ...
      <div className="grid flex-1 gap-3 md:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <aside className="rounded-2xl border border-white/10 bg-black/30 p-4">
          ...
          <p className="mt-2 text-[10px] leading-relaxed text-white/55">
            Project status comes from your GitHub connection. Terminal and
            preview readiness are reported separately above.
          </p>
          <button
            onClick={() => {
      ...
      <section className="rounded-2xl border border-white/10 bg-black/30 p-4">
        <div className="mb-4">
          ...
          <h3 className="mt-1 text-sm font-black">Choose the repository LiTT should work on</h3>
          <p className="mt-1 text-[10px] text-white/50">
            This is the real project source used by Studio—not a display-only selector.
          </p>
        </div>
