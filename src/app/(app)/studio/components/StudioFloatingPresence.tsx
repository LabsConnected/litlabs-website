...
export default function StudioFloatingPresence({
  ...
  return (
    <button
      ...
      className="group fixed right-4 z-40 flex items-center gap-2 rounded-full border px-2.5 py-2 transition-all hover:scale-105 hover:bg-white/5 active:scale-95 bottom-[calc(64px+env(safe-area-inset-bottom))] md:bottom-4"
      style={{
