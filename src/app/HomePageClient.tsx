...
const communityCards = [
  ...
  },
  {
    ...
    accent: "#a8ff2f",
    meta: "Example remixable project",
  },
  {
    ...
    accent: "#ffad72",
    meta: "Example community mission",
  },
];
    ...
    <main className="min-h-screen overflow-hidden bg-[#03050a] text-white selection:bg-[#a970ff] selection:text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 py-16 lg:min-h-190 lg:grid-cols-[.92fr_1.08fr] lg:px-8 lg:py-20">
          <div className="relative z-10">
            ...
            <h1 className="max-w-3xl text-5xl font-black leading-[.94] tracking-[-.055em] sm:text-6xl lg:text-7xl xl:text-[5.5rem]">
              Build apps, make art,
              <span className="block">and launch projects</span>
      ...
      <section id="discover" className="relative border-b border-white/10 bg-[#05070d] px-5 py-20 text-white lg:px-8 lg:py-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-3">
            {communityCards.map((card, index) => (
              <article key={card.title} className="group overflow-hidden rounded-[1.75rem] border border-white/12 bg-[#090c13] transition duration-500 hover:-translate-y-2 hover:border-white/30">
                <div className={`relative flex min-h-64 items-end overflow-hidden bg-linear-to-br ${card.gradient} p-6`}>
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-5 rounded-2xl border border-[#a8ff2f]/20 bg-[#a8ff2f]/4.5 px-6 py-5 sm:flex-row">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-4xl border border-cyan-300/20 bg-black shadow-[0_30px_100px_rgba(0,0,0,.55),0_0_60px_rgba(0,229,255,.07)]">
            <div className="relative aspect-video">
              ...
              <div className="absolute inset-0 bg-linear-to-r from-black/90 via-black/25 to-transparent" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {socialActions.map(({ icon: Icon, label, copy }) => (
              <div key={label} className="group flex items-start gap-4 rounded-2xl border border-white/10 bg-white/2 p-5 transition duration-300 hover:-translate-y-1 hover:border-[#a8ff2f]/25">
