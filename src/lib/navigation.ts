...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Canvas Builder", href: "/studio", icon: PenTool },
      { label: "Image", href: "/studio", icon: Image },
      { label: "Video", href: "/studio", icon: Video },
      { label: "Music", href: "/dashboard?app=music", icon: Music },
      { label: "Voice", href: "/dashboard?app=audio-tools", icon: Mic },
      { label: "AI Agents", href: "/agents", icon: Bot },
      { label: "Flow", href: "/studio", icon: Layers },
      { label: "Prompt Library", href: "/studio", icon: Library },
      { label: "Models", href: "/studio", icon: Aperture },
      { label: "History", href: "/studio", icon: Clock },
      {
        label: "Color by Number",
        href: "/studio",
        icon: Paintbrush,
      },
      { label: "Exports", href: "/studio", icon: Download },
      { label: "Templates", href: "/studio", icon: FileText },
      { label: "Workflows", href: "/studio", icon: Layers },
      { label: "Terminal", href: "/studio", icon: Terminal },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Retro ROMs", href: "/games/retro", icon: Gamepad2 },
      { label: "DOS Lab", href: "/games/dos", icon: Terminal },
      { label: "Cloud Saves", href: "/games/cloud", icon: Cloud },
  ...
  },
  {
    ...
    items: [
      { label: "Command Center", href: "/agents", icon: Bot, online: true },
      { label: "LiTT Director", href: "/agents/director", icon: Bot, online: true },
      { label: "Pixel Forge", href: "/agents/pixel-forge", icon: Sparkles },
      { label: "Champion", href: "/agents/champion", icon: Award },
      { label: "Memory Chat", href: "/chat", icon: MessagesSquare },
      { label: "Memories", href: "/memories", icon: Library },
      { label: "Agent Chat", href: "/agent-chat", icon: Wand2 },
      { label: "LiTT Local", href: "/jarvis", icon: Terminal },
    ],
  },
  {
    label: "System",
...
export const QUICK_CREATE_ITEMS = [
  { label: "Create Image", href: "/studio", icon: Image },
  { label: "Create Music", href: "/dashboard?app=music", icon: Music },
  { label: "Create Video", href: "/studio", icon: Video },
  { label: "Create Agent", href: "/agents", icon: Bot },
  { label: "Create Workflow", href: "/studio", icon: Layers },
  { label: "Create Post", href: "/social?create=post", icon: MessagesSquare },
  { label: "Start Stream", href: "/studio", icon: MonitorPlay },
  { label: "Upload", href: "/studio", icon: Download },
