...
export const GAME_LIBRARY: Game[] = [
  ...
  },
  {
    ...
    html5Url: "/games/play/2048/index.html",
    ...
    plays: "28.6K",
    status: "opensource",
    sourceAttribution: "Original game by Gabriele Cirulli (MIT) — self-hosted on litlabs.net",
  ...
  },
  {
    ...
    html5Url: "/games/play/hextris/index.html",
    ...
    plays: "31.4K",
    status: "opensource",
    sourceAttribution: "Original game by Logan Engstrom (GPL-3.0) — self-hosted on litlabs.net",
