...
export async function directorPlan(
  ...
  const prompt = `You are the LiTT Code LabStudios Hive Mind Director. Analyze the project state and plan the next task.
...
export async function executorCode(
  ...
  let prompt = `You are the LiTT Code LabStudios Hive Mind Executor. Implement the code for: ${targetFile}
