...
export default function DragDropCanvas({
  ...
  const [selectedItem, setSelectedItem] = useState<CanvasItem | null>(
  ...
  return (
    <div className="flex h-full">
      <div
        className="w-16 border-r flex flex-col items-center gap-2 p-2"
        style={{
        ...
        {selectedItem && (
          ...
          >
            <button
              ...
              style={{
                color: selectedItem.locked ? T.accentColor : T.textMuted,
              }}
              ...
              <input
                ...
                onChange={(e) =>
                  setItems(
                    items.map((item) =>
                      item.id === selectedItem.id
                        ? { ...item, zIndex: Number(e.target.value) }
                        : item,
                    ),
                  )
                }
