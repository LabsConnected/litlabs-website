...
const PHRASES: { patterns: string[]; action: LiTRouteAction }[] = [
  ...
  { patterns: ["take me to builder", "open builder", "build app", "build a website", "go to builder", "create app"], action: { type: "navigate", href: "/studio?tool=chat", label: "LiTTree Agent" } },
  { patterns: ["take me to agents", "open agents", "show agents", "my agents", "go to agents"], action: { type: "navigate", href: "/studio?tool=chat", label: "LiTTree Agent" } },
