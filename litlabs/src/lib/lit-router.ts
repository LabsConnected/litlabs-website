...
const SITE_MAP: Record<string, string> = {
  ...
  builder: "/studio?tool=builder",
  build: "/studio?tool=builder",
  app: "/studio?tool=builder",
  website: "/studio?tool=builder",
  agents: "/agents",
  agent: "/agents",
  gallery: "/gallery",
  games: "/games/cloud",
...
const PHRASES: { patterns: string[]; action: LiTRouteAction }[] = [
  ...
  { patterns: ["take me to builder", "open builder", "build app", "build a website", "go to builder", "create app"], action: { type: "navigate", href: "/studio?tool=builder", label: "Builder" } },
  { patterns: ["take me to agents", "open agents", "show agents", "my agents", "go to agents"], action: { type: "navigate", href: "/agents", label: "Agents" } },
