...
export const metadata: Metadata = {
  title: "404 — Page Not Found | LiTTree OS",
};
...
export default function NotFound() {
  return (
    <div
      ...
      style={{ backgroundColor: "#08080c", color: "#f0f0f6" }}
    >
      <div className="max-w-md w-full rounded-2xl p-8" style={{ border: "1px solid #1e1e2e", backgroundColor: "#101018" }}>
