 ...
 *
 * Server-side transport selection is covered by
 * terminal-server/__tests__/provider-transport-selection.test.ts. These
 * tests pin the CLI half of the same policy:
 *
