 ...
 *
 * Free-model fallback: if no LiTT-default or tier model is found, prefer
 * a free-priced model (pricing.unit === "free") over paid models, since
 * free models require no credits and always work. This ensures users
 * without funded provider accounts can still use LiTT out of the box.
 */
