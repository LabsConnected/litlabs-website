...
CREATE POLICY IF NOT EXISTS service_role_all_user_agents ON user_agents FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS service_role_all_memories ON memories FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS service_role_all_memory_permissions ON memory_permissions FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS service_role_all_agent_tool_permissions ON agent_tool_permissions FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS service_role_all_agent_approvals ON agent_approvals FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS service_role_all_agent_runs ON agent_runs FOR ALL TO service_role USING (true) WITH CHECK (true);
