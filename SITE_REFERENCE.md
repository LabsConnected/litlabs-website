...
**`components/` (42 files):** `CommandStudio.tsx` (main hub), `CommandStudioHeader.tsx`, `CommandStudioNav.tsx`, `StudioSidebar.tsx`, `StudioCommandDock.tsx`, `StudioPreviewPanel.tsx`, `StudioTerminalDrawer.tsx`, `StudioTranscript.tsx`, `StudioWorkspaceFrame.tsx`, `StudioActivityTimeline.tsx`, `StudioHealthPanel.tsx`, `StudioInspector.tsx`, `StudioModeSwitcher.tsx`, `StudioProjectFiles.tsx`, `StudioProjectPicker.tsx`, `ProjectDrawer.tsx`, `CommandComposer.tsx`, `BuilderStream.tsx`, `GenerationHistoryCard.tsx`, `ModelPicker.tsx`, `MyAITeam.tsx`, `ShareMenu.tsx`, `LiTEmptyState.tsx`, `LiTTPresence.tsx`, `LiveVoiceOverlay.tsx`, `CameraPreview.tsx`, `CameraSession.tsx`, `MediaRecorderPanel.tsx`, `VoiceDiagnosticsPanel.tsx`, `AttachmentMenu.tsx`, `AttachmentPreviewStrip.tsx`, `GitHubProjectConnection.tsx` + `canvas/` (ActionChips, BlockRenderer, CanvasPanel, RevisionHistory)
