...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Consolidation: merge standalone tools into Studio
      { source: "/memories", destination: "/studio?tool=memory", permanent: false },
      { source: "/voice", destination: "/studio?tool=voice", permanent: false },
    ];
  },
